...
- (void)updateContent {
    ...
    UIFont *largeSize = [UIFont fontWithName:@"HelveticaNeue-Light" size:(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? 32 : 16];
    UIFont *smallSize = [UIFont fontWithName:@"HelveticaNeue-Light" size:(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? 20 : 11];
