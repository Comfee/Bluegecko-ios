...
- (NSArray *)beaconRegistryEntries {
    ...
    return [allValues sortedArrayUsingComparator:^NSComparisonResult(id first, id second) {
        SILBeaconRegistryEntry *firstEntry = (SILBeaconRegistryEntry*)first;
        SILBeaconRegistryEntry *secondEntry = (SILBeaconRegistryEntry*)second;
    
        NSNumber *firstRSSI = [firstEntry.RSSIMeasurementTable lastRSSIMeasurement];
        NSNumber *secondRSSI = [secondEntry.RSSIMeasurementTable lastRSSIMeasurement];
        
        if (firstRSSI > secondRSSI) {
            return NSOrderedAscending;
        } else if (firstRSSI < secondRSSI) {
